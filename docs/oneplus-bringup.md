...
- Public downstream/vendor clues found:
  ...
  - Android/OxygenOS source/artifact inspection:
    ...
    - Persisted a UCM `Mic` capture device using the proven bottom mic route: `MultiMedia2`/`SLIMBUS_0_TX`, `AIF1_CAP SLIM TX7`, `ADC4`, `hw:O6T,1`, mono capture. Next boot should expose a UCM source alongside the existing Speaker sink.
